...
(() => {
/*!********************************************!*\
  !*** ./src/main/js/admin/add-sub-theme.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
const flowId = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.extractIdsFromUrl)(window.location.href.substring(window.location.href), 'sub-theme')
