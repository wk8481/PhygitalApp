...
[Service]
User=root
ExecStart=/usr/bin/java -jar /opt/Team_5_Phygital-0.0.1-SNAPSHOT.jar
...
# Only enabling the service here because the of the cloud sql proxy which is set up later
